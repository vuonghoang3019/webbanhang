...
<?php include ("../../layout/header.php");   ?>
                    <div class="container-fluid">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Sửa sản phẩm
                            </h1>                           
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="number" class="form-control" placeholder="Sale" id="sale" name="sale" value="<?php echo $EditProduct['sale'] ?>">                                                                   
                                            </div>
                                            <br>              
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input type="file" class="form-control" id="img" name="img" value="<?php echo $EditProduct['img'] ?>">  
                                                <?php
                                                    if(isset($erorr['img'])):
                                                ?>
                                                ...
                                                ?> 
                                                <br>
                                            <img class="float:right" src="<?php echo upload(); ?>products/<?php echo $EditProduct['img']; ?>" width="100px" height="100px"  alt="">
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="content" id="" cols="30" rows="4" class="form-control"><?php echo $EditProduct['content'] ?></textarea>
                                            <?php
